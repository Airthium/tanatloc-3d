  ...
  return (
    <>
      ...
      <Typography>
        ...
        <Typography.Text code>about:config</Typography.Text> in your search bar
      </Typography>
      <Typography.Title level={5} mark={true}>
        2- Check if enabled
      </Typography.Title>
      <Typography>
        ...
        and switch value to <Typography.Text code>true</Typography.Text> (double
        click on the value)
      </Typography>
      <Typography.Title level={5} mark={true}>
      ...
      <Typography>Update to the latest version and retry all steps.</Typography>
    </>
  )
}
